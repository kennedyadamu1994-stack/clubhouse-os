...
export default async function Trending({
  ...
  const [topics, favouritedKeys] = await Promise.all([
  ...
  return (
    <div className="card outreach-card">
      ...
      {topics.length === 0 ? (
        ...
        <TrendingBoard topics={topics} categoryLabels={CATEGORY_LABEL} clubToken={clubToken} club_id={club.club_id} favouritedKeys={favouritedKeys} />
      )}
    </div>
  );
}
