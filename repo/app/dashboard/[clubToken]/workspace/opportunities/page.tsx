    ...
    return {
      ...
      card: (
        <EntryCard
          ...
          actions={
            isCallout
              ? [{ action_key: "contact_us", label: "Offer to help", colour: "pink", token_cost: 0 }]
              : [
                  ...(o.link
                    ? [{ action_key: "view_opportunity", label: "View details", colour: "black" as const, token_cost: 0, href: o.link }]
                    : []),
                  { action_key: "contact_us", label: "Ask about this", colour: "pink", token_cost: 0 },
                ]
          }
  ...
  return (
    <div className="card outreach-card">
      ...
      {opportunities.length === 0 ? (
        <EmptyState
          message="No open opportunities right now — check back soon, or list your own call-out above."
