    ...
    <>
      ...
      <div className="grid">
        {/* Club Health — replaces Profile completeness entirely (Kennedy's
            ...
            for it yet) — never shows broken/zeroed bars. Stacked above
            KPIs, both full width (18 Sep design pass briefly put these
            side by side in a narrower 3:2 split — reverted, Kennedy: "that
            has changed" and shouldn't have; KPIs in particular needs its
            full-width swipeable .kpi-grid carousel, not a squeezed 2/5
            column). */}
        ...
        {/* KPIs — visual language matches the reference "Performance" cards (accent top
            ...
            template. .kpi-grid is a horizontal scroll-snap carousel (fixed 220px cards,
            overflow-x: auto) — full card width here, not the narrower column the 18 Sep
            side-by-side attempt gave it. */}
