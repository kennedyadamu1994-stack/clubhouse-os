  ...
  return (
    <>
      ...
      <div className="grid">
        ...
        {/* Top 5 recommendations, soonest-dated first — no relevance badge here (1 Sep): Sponsorship & Funding and Opportunities don't have reason chips in this pass, see lib/scoring.ts */}
        <CollapsibleCard
          id="recs"
          defaultOpen={false}
          heading={
