  ...
  const searchIndex: SearchIndexEntry[] = [
    ...
    ...people.map((p) => {
      ...
      return {
        ...
        actions: [{ action_key: "person_request", label: `Book this ${roleLabel.toLowerCase()}`, colour: "pink" as const, token_cost: 2 }],
    ...
    ...services
      ...
      .map((s) => ({
        ...
        href: `${base}/services`,
        detail: s.description || undefined,
        searchText: [s.name, SERVICE_CATEGORY_LABEL[s.category] ?? s.category, s.description].join(" ").toLowerCase(),
      })),
