      ...
      <div className="cardgrid" style={{ marginBottom: 20 }}>
        <article className="mcard">
          <div className="mc-top">
            <span className="mc-ic" aria-hidden>
              ⚽
            </span>
            <h3>Player Outreach</h3>
          </div>
          <p className="mc-status">Find and invite players in your neighbourhood.</p>
          <a className="btn btn-pink" href={`${base}/outreach/players`}>
            Start outreach
          </a>
        </article>
        <article className="mcard">
          ...
          <p className="mc-status">Local businesses and funding matched to your club.</p>
          <a className="btn btn-pink" href={`${base}/outreach/brands`}>
            Review outreach
          </a>
        </article>
        <article className="mcard">
          <div className="mc-top">
            ...
            <h3>Influencers &amp; Clubs</h3>
          </div>
          <p className="mc-status">Local voices and neighbouring clubs to connect with.</p>
          <a className="btn btn-pink" href={`${base}/outreach/influencers`}>
            View options
          </a>
        </article>
        <article className="mcard">
          ...
          <p className="mc-status">Insights, opportunities, and resources — coming next.</p>
          <span className="chip">Next in the build</span>
        </article>
        <article className="mcard">
          <div className="mc-top">
            <span className="mc-ic" aria-hidden>
          ...
          <p className="mc-status">Find sessions, your calendar, and support — coming next.</p>
          <span className="chip">Next in the build</span>
        </article>
        <article className="mcard">
          <div className="mc-top">
          ...
          <p className="mc-status">Hands-on help from The NBRH team — coming next.</p>
          <span className="chip">Next in the build</span>
        </article>
      </div>
