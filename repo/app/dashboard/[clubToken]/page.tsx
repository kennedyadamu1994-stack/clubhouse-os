...
export default async function Overview({ params }: { params: Promise<{ clubToken: string }> }) {
  ...
  // route-blocked: Workspace (Opportunity/Resource/FAQ/Perk/Trending) and
  // Tools categories are dropped entirely, and Outreach's Person/Brand/
  ...
  // already points at a real page, and 5 of those pages now 404 for Free
  // — this keeps the search bar from ever linking there in the first
  // place, rather than surfacing a dead link.
                ...
                <div className="rec" key={`${r.kind}-${r.id}`}>
                  <div className="rec-body">
                    <div className="rec-title">
                      <ReasonChips chips={r.chips} /> {r.title}
                    </div>
