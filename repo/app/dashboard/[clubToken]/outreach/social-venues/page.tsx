...
/**
 * New Outreach subsection, sourced from the real "SOCIAL VENUE" worksheet
 * (Kennedy confirmed the sheet was created, 27 Aug follow-up) — see
 * SocialVenue's full doc comment and column mapping in lib/types.ts.
 * Rebuilt from the earlier placeholder that mirrored ClubDirectoryEntry's
 * shape before this sheet existed — real fields (borough, best_for,
 * rating, verified_by_nbrh, etc.) replace the old area/open_to/bio stand-ins.
 *
