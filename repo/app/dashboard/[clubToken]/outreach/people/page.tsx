...
export default async function PeopleOutreach({
  ...
  const entries: OutreachEntry[] = people.map((p) => {
    const score = hasPriorities ? matchScore(club, { sports: p.sports, area: p.area }, weights) : undefined;
    ...
    return {
      ...
      card: (
        <EntryCard
          ...
          actions={[{ action_key: "person_request", label: "Request this person", colour: "pink", token_cost: 1 }]}
