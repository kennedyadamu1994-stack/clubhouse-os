...
export default async function BrandsOutreach({
  ...
  const entries: OutreachEntry[] = brands.map((b) => {
    const score = hasPriorities ? matchScore(club, { area: b.area, tags: b.partnership_interests }, weights) : undefined;
    return {
      key: b.brand_id,
  ...
  return (
    <div className="card outreach-card">
      ...
      <p style={{ color: "var(--faint-text)", fontSize: "0.78rem", marginBottom: 14, fontStyle: "italic" }}>
