...
import { getsServiceDiscount } from "@/lib/types";
  ...
  return (
    <div className="card outreach-card">
      ...
      <p style={{ color: "var(--dim)", fontSize: "0.9rem", marginTop: -8, marginBottom: 20, maxWidth: "56ch" }}>
        Paid support from The NBRH. Getting in touch is always free, you&apos;re only ever
        charged for what you actually book.
      </p>
      ...
      {services.length === 0 ? (
        ...
        <PaginatedList
          className="cardgrid service-cardgrid"
          items={services.map((s) => (
            <ServiceCard
              ...
              premiumHourlyRateGbp={s.premium_hourly_rate_gbp}
              isDiscountEligible={getsServiceDiscount(club.plan_tier)}
