 ...
 * .btn-black convention). These are close to but not identical to
 * --pink (#ff1b6e), so they're applied as literal hex values here
 * rather than substituted for the token — Kennedy gave exact codes
 * this time, not a request to reuse the existing brand colour.
 *
  ...
  return (
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexWrap: "wrap" }}>
        <SplashPanel href={chosHref} background="#3a86ff" title="Club House OS" description="For clubs — outreach, sponsorship, and tools." Icon={Building2} />
        <SplashPanel href="/players" background="#ff006e" title="Player OS" description="For players — find sessions, clubs, and opportunities near you." Icon={UserRound} />
      </div>
    </main>
  );
}
