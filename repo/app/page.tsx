 ...
 * every earlier colour revision of this page. Deliberately NOT wired
 * to the palette picker in the footer (confirmed explicitly) — this
 * splash page has never been theme/palette-aware at all, and stays
 * that way: it always shows lavender/sunset specifically, regardless
 * of whichever palette a visitor has chosen elsewhere in the app.
 *
