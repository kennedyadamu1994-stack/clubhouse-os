 ...
 *
 * Pink for Player OS (this app's own real, confirmed-AA-compliant
 * --pink token, text always white per the established D11 decision —
 * see app/globals.css's own comment on that token) and black for Club
 * House OS (the same .btn-black "self-serve action" convention already
 * used elsewhere in this app, not an arbitrary second colour).
 *
  ...
  return (
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexWrap: "wrap" }}>
        <SplashPanel href={chosHref} background="#000000" title="Club House OS" description="For clubs — outreach, sponsorship, and tools." Icon={Building2} />
        <SplashPanel href="/players" background="var(--pink)" title="Player OS" description="For players — find sessions, clubs, and opportunities near you." Icon={UserRound} />
      </div>
    </main>
  );
}
