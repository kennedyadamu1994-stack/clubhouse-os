 ...
 * pages." The landing page needs its own minimal header, not the full
 * sidebar/tab-bar shell, so this group keeps it out from under this
 * layout entirely (the CHOS/POS choice screen itself now lives at "/",
 * not a separate /choose route under app/players/ at all — see
