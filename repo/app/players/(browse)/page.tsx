 ...
 * (and the div that only existed to wrap it) is removed entirely
 * (Kennedy: "remove this line completely... ensure everything below it
 * moves up the page to fill the spot"). Nothing replaces it — the
 * signed-in card / sign-in card below is now the first thing in the
 * page body, right under the shared deck-title header.
 */
