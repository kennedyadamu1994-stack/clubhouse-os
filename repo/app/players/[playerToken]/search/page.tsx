 ...
 * collide with.
 *
 * No in-card "Search" heading (15 Sep) — see the public Search page's
 * own doc comment for why.
 *
 * PlayerSearchEngine is wrapped in <Suspense> (15 Sep) — see the
 * public Search page's own doc comment for why: it now reads
 * useSearchParams() internally, which Next.js requires to sit under a
 * Suspense boundary.
 */
