      ...
      <div className="shell">
        ...
        <div className="main">
          ...
          {/* Theme toggle moved here, right below the carousel (18 Sep,
              ...
              the fuller reasoning). Eyebrow "Hello, {name}" and date both
              removed outright, not relocated — the player's own name still
              appears elsewhere on Home itself ("Hey, {name}" — see
              page.tsx's own doc comment on why that duplication is
              intentional), so removing it here doesn't lose it entirely. */}
