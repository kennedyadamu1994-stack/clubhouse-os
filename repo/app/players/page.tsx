      ...
      <header className="app-header">
        <div className="app-header-inner">
          <div className="app-header-brand">
            ...
            {/* Points at /choose (15 Sep fix), the real CHOS/POS splash — was thenbrh.co.uk, which Kennedy flagged as wrong: "why doesn't it just go back to the CHOS?" /directory itself stays avoided directly here since it's admin-gated (see app/directory/page.tsx); /choose is honest about that limitation in its own doc comment rather than this page silently biting the bullet on a bad direct link. */}
            <Link href="/choose" className="app-header-mode-label">
