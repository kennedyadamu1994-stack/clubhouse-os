      ...
      <header className="app-header">
        <div className="app-header-inner">
          <div className="app-header-brand">
            ...
            {/* Points at "/" (15 Sep fix), the real CHOS/POS choice screen — that content used to live at a separate /choose route, which is now folded into "/" so the actual root link is the choice, not a separate page nothing pointed new visitors at. Was thenbrh.co.uk before that, which Kennedy flagged as wrong: "why doesn't it just go back to the CHOS?" */}
