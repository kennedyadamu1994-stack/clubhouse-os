 ...
 * device.
 *
 * The collapsed row shows the real Title column (Kennedy added this to
 * the INBOX sheet, 27 Aug follow-up — resolves the earlier limitation
 * where there was no subject line, only a combined message body), with
 * the full message shown on expand.
 *
