 ...
 * name]" + date + inline toggle, unchanged from before 18 Sep.
 *
 * playerName is only ever passed by the signed-in layout (there's a
 * real name to show); the public layout omits it and the eyebrow just
 * reads "Hello" alone, matching each page's original behaviour.
 */
