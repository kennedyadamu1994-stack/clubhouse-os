 ...
 * app/page.tsx's own doc comment) — since there's no logged-in club to
 * return to from a public POS page, there's no more specific page to
 * send someone back to than the same choice screen both sides land on.
 */
