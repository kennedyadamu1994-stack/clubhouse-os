...
import { Menu, Heart, Inbox, ArrowLeftRight, LogOut, LogIn, Map, Gift, BookOpen, ShoppingBag } from "lucide-react";
 ...
 *
 * Map/Perks/Guide/Club Store (15 Sep, Kennedy: "add a Map page from
 * the CHOS & add it into the drop down menu in the POS" / "add a Perks
 * page to the drop down" / "add a Guide page to the drop down" / "add
 * a Club store page to the drop down") live in THIS dropdown, not the
 * 5-item sidebar/tab bar — genuinely secondary pages. Unlike
 * Favourites/Inbox, these are token-aware, not email-session-gated —
 * they work identically whether or not a player is signed in or holds
 * a token, so they build their href from playerToken when present, the
 * public path when not, the same pattern PlayerNavLinks already uses.
 *
