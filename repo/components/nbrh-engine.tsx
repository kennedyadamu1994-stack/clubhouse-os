...
interface NbrhEngineProps {
   ...
   * `${linkBase}/${category-slug}` instead of in-component
   * setCategory() buttons — this is the actual Search-into-real-routes
   * split Kennedy asked for (15 Sep: "utilises the drop down bar
   * [routes] to change pages" instead of the self-contained tool).
      ...
      <div className="sr-category-tabs">
        {visibleCategories.map((cat) =>
          linkBase ? (
            ...
            <Link
              key={cat}
              href={`${linkBase}/${CATEGORY_SLUG[cat]}`}
