 ...
 * Clubs" link, components/player-header.tsx) points at "/" instead of
 * straight back here — "/" is now the real CHOS/POS choice screen
 * (15 Sep restructure, folding in what used to be a separate /choose
 * page — see app/page.tsx's own doc comment for why), since there's no
 * single, equivalently real public CHOS landing page to send a
 * player-side visitor straight to.
 *
