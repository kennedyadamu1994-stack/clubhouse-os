    ...
    <header className="app-header">
      <div className="app-header-inner">
        <div className="app-header-brand">
          ...
          {/*
            Static text only (Kennedy, 9 Sep: "In the near future, I want
            to implement a switchable toggle that will switch between the
            CHOS for clubs and the POS for players... put a 'For Clubs'
            text next to the NBRH logo") — no toggle exists yet, and
            Kennedy explicitly confirmed this should be plain text for
            now, not a working control. The "|" is a real character, not
            a border, so it reads correctly for anyone using a screen
            reader too.
          */}
          <span className="app-header-mode" aria-hidden>
            |
          </span>
          <span className="app-header-mode-label">For Clubs</span>
        </div>
