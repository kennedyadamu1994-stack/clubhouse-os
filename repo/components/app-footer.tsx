  ...
  return (
    <footer className="app-footer">
      <div className="app-footer-inner">
        ...
        {/* Palette picker + theme toggle grouped in one row (19 Sep,
            Kennedy: "put the light/dark mode toggle on the same line as
            the palette theme toggles") — both were already adjacent
            flex children of .app-footer-inner, which sits fine side by
            side on desktop, but .app-footer-inner switches to a column
            stack on mobile (app/globals.css, its own 780px rule), which
            put every child — including these two — on its own separate
            line. Wrapping them in one .app-footer-toggles div keeps
            them as a single flex row that survives the parent's column
            stack, so they stay on one line at every width instead of
            only accidentally lining up when there happened to be room. */}
