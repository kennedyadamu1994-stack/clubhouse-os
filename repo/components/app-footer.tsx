  ...
  return (
    <footer className="app-footer">
      <div className="app-footer-inner">
        ...
        {/* ThemeToggle moved here, 19 Sep (Kennedy: "the light/dark mode
            toggle, put it in the footer") — previously lived inline in
            each deck header (components/greeting.tsx's ClubDeckHeader,
            components/player-nav.tsx's PlayerDeckHeader), rendered twice
            per app (once on Overview/Home, once on every other page).
            One instance here now covers all of CHOS and POS, same as
            PaletteToggle right above it. */}
        <ThemeToggle />
