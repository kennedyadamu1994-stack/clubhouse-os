...
const HEALTH_LABELS: { key: keyof ClubHealth; label: string; description: string; icon: LucideIcon }[] = [
  {
    ...
    label: "Awareness",
    description:
      "How visible your club is to people nearby who might want to join or support you. A higher score means more local players and businesses have actually heard of you.",
    icon: Eye,
  },
  {
    key: "user_reviews",
    label: "User Reviews",
    description:
      "What players and parents are saying about their experience with your club. This reflects real feedback, not just how many people you reach.",
    icon: Heart,
  },
  {
    key: "nbrh_quality",
    label: "NBRH Quality",
    description:
      "How complete and well-maintained your club's profile is on The NBRH. A higher score means clubs, sponsors, and players get an accurate picture of you.",
    icon: Star,
  },
  {
    key: "management",
    label: "Management",
    description:
      "How consistently your club runs day-to-day, from session regularity to admin follow-through. This is about reliability, not size.",
    icon: ClipboardCheck,
  },
  {
    ...
    description:
      "How well set up your club is online: a working booking system and a usable website, at minimum. This is the groundwork everything else builds on.",
    icon: Wifi,
  },
];
