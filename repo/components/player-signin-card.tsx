  ...
  return (
    <div className="for-you-login" style={{ margin: "0 auto" }}>
      ...
      <p className="for-you-login-intro">
        Personalised recommendations are only available to registered members. Creating an
        account is free and takes less than two minutes.
      </p>
      <p className="for-you-login-intro" style={{ marginTop: 8 }}>
        Once you&apos;re signed up, come back here and enter your email to see sessions matched to
        your location, sports, and skill level. Already have an account? Enter your registered
        email address and we&apos;ll pull up sessions matched to your profile and preferences.
      </p>
