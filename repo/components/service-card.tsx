...
interface ServiceCardProps {
  ...
  /** From SERVICES' real "Pricing Type" column (14 Sep) — "one_off" shows the price on its own, with no "/hr" suffix. */
  pricingType: ServicePricingType;
  /** Discounted rate for Premium clubs, from SERVICES' real "Discount if on Premium Plan" column (20 Aug) — null when this service has no discount. Applies under either pricing type. */
...
export function ServiceCard({
  ...
  const unitSuffix = pricingType === "one_off" ? null : <span>/hr</span>;
