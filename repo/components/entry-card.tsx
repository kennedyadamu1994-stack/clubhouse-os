...
interface EntryCardProps {
  ...
  tags: string[];
  /** v3 relevance chips (replaces the old 0-100 matchScore) — see lib/relevance.ts. Shown inline with the entry's other small badges (Sponsored/Verified/New), same size, not in the meta row with tags. Omit entirely for subsections that don't have chips (e.g. Sponsorship & Funding, Influencers, Opportunities). */
    ...
    <div className={`entry-row ${sponsored ? "entry-row-sponsored" : ""}`}>
      ...
      <div className="entry-main">
        ...
        <div className="entry-meta">
          {subtitle && <span className="entry-sub">{subtitle}</span>}
          {visibleTags.map((t) => (
