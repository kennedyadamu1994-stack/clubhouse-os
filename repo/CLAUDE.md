...
Dark `#1B1B1B` background · hot pink `#FF1B6E` accent · Young Serif headings · DM Sans body · 4px radius. Kennedy's decided overrides (do NOT revert): text on solid-pink backgrounds is always WHITE (his call, accepting ~3.7:1 contrast); the entry detail toggle is a white italic "i" in a soft black box, never an eye icon or emoji.
