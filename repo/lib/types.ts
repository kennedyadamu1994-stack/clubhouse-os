 ...
 *
 * No `score` field (removed 1 Sep with the v3 relevance rebuild) —
 * Sponsorship & Funding and Opportunities don't get reason chips in this
 * pass (Kennedy's call, 1 Sep: chips ship for Players/Clubs/Brands first),
 * so there's no relevance signal to show here either. Sorted by nearest
 * date instead — see topRecommendations in lib/scoring.ts.
 */
