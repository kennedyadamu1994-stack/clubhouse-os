...
export function getAdapter(): DataAdapter {
  ...
  // Ledger writes (Actions_Log / token balance) go to Postgres once POSTGRES_URL
  // exists — see lib/data/postgres.ts for why only that slice moved, not
  // everything. Reference data (clubs, players, etc.) stays on the Local/Sheets
  // adapter regardless — Kennedy's decision (club-house-os memory, "split data
  // architecture"): reads stay on Sheets, OS-generated writes go to a real DB.
