...
export function topRecommendations(
  ...
  // priorities has been removed entirely (Kennedy, 20 Aug). Previously
  // short-circuited to [] until a club set priorities; that setup step no
  // longer exists, so recommendations run on sport/area/urgency alone from
  // the start.
