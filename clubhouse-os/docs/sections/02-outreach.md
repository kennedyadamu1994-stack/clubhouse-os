...
Six subsections, one interaction pattern, all built from the Entry Card + Action Pop-up components. This is where the token/notification backbone handles its first real requests.
